...
const stripJsonComments = (raw) =>
  raw.replaceAll(/\/\*[\s\S]*?\*\//g, "").replaceAll(/^\s*\/\/.*$/gm, "");

const readVSCodeTheme = (variant) => {
  const path = resolve(
    vscodeThemeRoot,
    `santi020k-${variant}-color-theme.json`,
  );
...
const buildTheme = (variant) => {
  ...
  const syntaxColors = {
    comment: getSemanticColor(
      semantic,
      "comment",
      hex(colors, "descriptionForeground"),
    ),
    ...
    string: getSemanticColor(
      semantic,
      "string",
      hex(colors, "terminal.ansiGreen"),
    ),
    number: getSemanticColor(
      semantic,
      "number",
      hex(colors, "terminal.ansiCyan"),
    ),
    boolean: getSemanticColor(
      semantic,
      "enum",
      getSemanticColor(semantic, "class", hex(colors, "terminal.ansiMagenta")),
    ),
    ...
    type: getSemanticColor(
      semantic,
      "type",
      getSemanticColor(semantic, "class", hex(colors, "terminal.ansiCyan")),
    ),
    class: getSemanticColor(
      semantic,
      "class",
      hex(colors, "terminal.ansiMagenta"),
    ),
    ...
    decorator: getSemanticColor(
      ...
      hex(
        ...
        hex(colors, "terminal.ansiYellow"),
      ),
    ),
  ...
  return {
    ...
    style: {
      ...
      "border.disabled": hex(
        ...
        hex(colors, "panel.border"),
      ),
      "border.focused": hex(
        colors,
        "focusBorder",
        hex(colors, "tab.activeBorder"),
      ),
      ...
      "border.variant": hex(
        colors,
        "tab.border",
        hex(colors, "sideBar.border"),
      ),
      conflict: hex(
        colors,
        "mergeEditor.conflict.unhandledFocused.border",
        hex(colors, "editorError.foreground"),
      ),
      "conflict.background": hex(
        colors,
        "mergeEditor.conflict.input1.background",
        hex(colors, "editor.lineHighlightBackground"),
      ),
      "conflict.border": hex(
        colors,
        "mergeEditor.conflict.unhandledFocused.border",
      ...
      "drop_target.background": hex(
        ...
        hex(colors, "selection.background"),
      ),
      ...
      "editor.document_highlight.read_background": hex(
        ...
        hex(
          ...
          hex(colors, "editor.symbolHighlightBackground"),
        ),
      ),
      ...
      "editor.subheader.background": hex(
        ...
        hex(colors, "panelSectionHeader.background"),
      ),
      ...
      "element.active": hex(
        ...
        hex(
          ...
          hex(colors, "commandCenter.activeBackground"),
        ),
      ),
      "element.background": hex(
        colors,
        "editorWidget.background",
        hex(colors, "sideBar.background"),
      ),
      "element.disabled": hex(
        colors,
        "sideBar.background",
        hex(colors, "window.inactiveBorder"),
      ),
      "element.hover": hex(
        colors,
        "list.hoverBackground",
        hex(colors, "tab.hoverBackground"),
      ),
      ...
      "ghost_element.active": hex(
        ...
        hex(
          ...
          hex(colors, "list.activeSelectionBackground"),
        ),
      ),
      ...
      modified: hex(
        colors,
        "textLink.foreground",
        hex(colors, "editorInfo.foreground"),
      ),
      ...
      "panel.indent_guide": hex(
        ...
        hex(colors, "editorIndentGuide.background1"),
      ),
      "panel.indent_guide_active": hex(
        colors,
        "tree.indentGuidesStroke",
        hex(colors, "editorIndentGuide.activeBackground1"),
      ),
      "panel.indent_guide_hover": hex(
        colors,
        "list.hoverBackground",
        hex(colors, "tree.indentGuidesStroke"),
      ),
      players: [],
      predictive: hex(
        colors,
      ...
      "predictive.background": hex(
        ...
        hex(colors, "editorGhostText.foreground"),
      ),
      ...
      "scrollbar.thumb.hover_background": hex(
        colors,
        "scrollbarSlider.hoverBackground",
        hex(colors, "list.hoverBackground"),
      ),
      ...
      "search.match_background": hex(
        ...
        hex(colors, "editorOverviewRuler.findMatchForeground"),
      ),
      "status_bar.background": dark
        ...
        : hex(
            ...
            hex(colors, "sideBarSectionHeader.background"),
          ),
      ...
      "success.border": hex(
        colors,
        "editorGutter.addedBackground",
        hex(colors, "terminal.ansiGreen", "#28a745"),
      ),
      "surface.background": hex(
        colors,
        "sideBar.background",
        hex(colors, "panel.background"),
      ),
      syntax: {
      ...
      "tab_bar.background": hex(
        colors,
        "titleBar.activeBackground",
        hex(colors, "activityBar.background"),
      ),
      ...
      "terminal.bright_foreground": hex(
        ...
        hex(colors, "terminal.foreground"),
      ),
      ...
      "title_bar.inactive_background": hex(
        ...
        hex(colors, "titleBar.activeBackground"),
      ),
