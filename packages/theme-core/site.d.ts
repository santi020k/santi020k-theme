...
export function getPreferredSiteTheme(
  options?: SiteThemePreferenceOptions,
): SiteTheme;
...
export function syncSiteThemeToggle(
  toggle?: HTMLElement | null,
  root?: HTMLElement,
): void;
export function setSiteNavOpen(
  isOpen: boolean,
  options?: SiteNavigationOptions,
): void;
export function bindSiteNavigation(options?: SiteNavigationOptions): () => void;
export function bindPreferredSiteThemeSync(
  options?: PreferredSiteThemeSyncOptions,
): () => void;
