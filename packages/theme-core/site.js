...
export const getSiteUrls = (development = false) => development ? SITE_URLS.development : SITE_URLS.production
...
export const bindPreferredSiteThemeSync = ({
  ...
  const syncPreferredTheme = event => {
    ...
    setSiteTheme(event.matches ? SITE_THEME_LIGHT : SITE_THEME_DARK, {
      root,
      storage
    })
